...
class _SekillerState extends State<Sekiller> {
  ...
  Future<void> saveIndex(int value) async {
    ...
    pref.setInt('sekilIndexSave', test1);
  ...
  Future<void> readIndex() async {
    ...
    int test2 = pref.getInt('sekilIndexSave');
  ...
  final List<String> sekilEList =[
    "Square","Pentagon","Circle","Triangle","Cube","Star","Oval",
    "Ractangle","Hexagon","Heart"
            ...
            return Column(
              ...
              children: [
                ...
                Text(sekilList[index],
                    style: GoogleFonts.robotoSlab(
                        fontSize: 34.0, color: Colors.blueGrey)),
                FloatingActionButton(
                  backgroundColor: Colors.black38,
                  onPressed: (){
                    isSpeaking ? stop() : speak(sekilEList[index]);
